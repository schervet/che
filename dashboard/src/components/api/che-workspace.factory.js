...
export class CheWorkspace {
   ...
   */
  constructor ($resource, $q, cheWebsocket, lodash, cheEnvironmentRegistry) {
    // keep resource
    ...
    cheEnvironmentRegistry.addEnvironmentManager('compose', new ComposeEnvironmentManager());
    cheEnvironmentRegistry.addEnvironmentManager('dockerfile', new DockerFileEnvironmentManager());
