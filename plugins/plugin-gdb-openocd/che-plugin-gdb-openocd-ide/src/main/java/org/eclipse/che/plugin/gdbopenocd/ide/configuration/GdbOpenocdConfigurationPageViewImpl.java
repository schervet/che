...
/**
 * The implementation of {@link GdbOpenocdConfigurationPageView}.
 *
 * @author Artem Zatsarynnyi
 */
public class GdbOpenocdConfigurationPageViewImpl implements GdbOpenocdConfigurationPageView {

    private static final GDBOpenocdConfigurationPageViewImplUiBinder UI_BINDER = GWT.create(GDBOpenocdConfigurationPageViewImplUiBinder.class);
    ...
    public GdbOpenocdConfigurationPageViewImpl() {
    ...
    interface GDBOpenocdConfigurationPageViewImplUiBinder extends UiBinder<FlowPanel, GdbOpenocdConfigurationPageViewImpl> {
    }
}
