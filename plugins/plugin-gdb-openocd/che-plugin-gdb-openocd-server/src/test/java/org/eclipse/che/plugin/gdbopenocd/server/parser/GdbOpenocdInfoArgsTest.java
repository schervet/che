 ...
 */
public class GdbOpenocdInfoArgsTest {
    ...
    public void testParse() throws Exception {
        ...
        GdbOpenocdInfoArgs gdbOpenocdInfoArgs = GdbOpenocdInfoArgs.parse(gdbOpenocdOutput);

        Map<String, String> variables = gdbOpenocdInfoArgs.getVariables();
