...
public class GdbOpenocdContinue {
     ...
     * Factory method.
     */
    public static GdbOpenocdContinue parse(GdbOpenocdOutput gdbOpenocdOutput) throws GdbOpenocdParseException {
        ...
        for (String line : output.split("\n")) {
            ...
            if (matcher.find()) {
                ...
                return new GdbOpenocdContinue(new BreakpointImpl(location));
            }
        }

        return new GdbOpenocdContinue(null);
    }
}
