 ...
 */
public class GdbOpenocdDebuggerFactory implements DebuggerFactory {
    private static final String TYPE = "gdbOpenocd";
    ...
    public Debugger create(Map<String, String> properties, Debugger.DebuggerCallback debuggerCallback) throws DebuggerException {
        ...
        return GdbOpenocdDebugger.newInstance(host, port, file, sources, debuggerCallback);
    }
}
